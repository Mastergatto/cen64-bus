...
#   Makefile for *NIX.
#
#   BUSSIM: Bus Interface SIMulator.
...
all: CFLAGS = $(COMMON_CFLAGS) $(RELEASE_CFLAGS) $(BUS_FLAGS)
all: $(TARGET)

debug: CFLAGS = $(COMMON_CFLAGS) $(DEBUG_CFLAGS) $(BUS_FLAGS)
debug: $(TARGET)

all-cpp: CFLAGS = $(COMMON_CXXFLAGS) $(RELEASE_CFLAGS) $(BUS_FLAGS)
all-cpp: $(TARGET)
all-cpp: CC = $(CXX)

debug-cpp: CFLAGS = $(COMMON_CXXFLAGS) $(DEBUG_CFLAGS) $(BUS_FLAGS)
debug-cpp: $(TARGET)
debug-cpp: CC = $(CXX)
